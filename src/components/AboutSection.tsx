          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="glitch-card p-6 rounded-lg">
              <p className="text-lg text-gray-300 leading-relaxed">
                At Glitch Design, we embrace distortion to find clarity. We're a boundary-pushing design studio that thrives on the intersection of art and code. Our work is raw, real, and ruthlessly creative — built for brands ready to stand out.
              </p>
            </div>
