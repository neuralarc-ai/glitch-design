...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    console.log('Attempting to send discovery call email with options:', {
    ...
    console.log('Discovery call email sent successfully:', {
    ...
    console.error('Error sending discovery call email:', error);
